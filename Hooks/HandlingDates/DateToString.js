...
const days1 = ['понедельник','вторник','среду','четверг','пятницу','субботу'] // Винительный падеж
const days2 = ['понедельник','вторник','среда','четверг','пятница','суббота'] // Именительный падеж
...
export default function (date) {
  ...
  if (dif < -1 * 60 * 60 * 24) {
    ...
    return date.date + " (" + days2[GetWeekday(date)] + ")"
  }
}