...
export default function App({ navigation, route }) {
  ...
  const [items, setItems] = useState(route.params.data.data.students);
  ...
  const saveUser = async () => {
    if (pickedValue) {
      ...
      route.params.data["userName"] = pickedValue;
      navigation.navigate("MenuAndroid", route.params.data);
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <DropDownPicker
        ...
        theme={route.params.data.theme.toUpperCase()}
      />
